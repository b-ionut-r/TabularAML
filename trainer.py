...
class Trainer:
    ...
    def _train_best_on_folds(self):
        ...
        for df in [self.xgb_lb, self.lgb_lb, self.cat_lb, self.rf_lb]:
            if df is not None:
    ...
    def _train_best_on_full_train_data(self):
        ...
        self.all_lbs = [self.xgb_lb, self.lgb_lb, self.cat_lb, self.rf_lb]
    ...
    def get_leaderboard(self) -> pd.DataFrame:
        ...
        leaderboards = [x for x in [self.lgb_lb, self.cat_lb, self.xgb_lb, self.rf_lb] if x is not None]
