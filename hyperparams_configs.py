...
LIGHT_CONFIG = { 
                    ...
                    "XGB": {
                        ...
                        "subsample": (0.5, 1.0, "float"),
                        "colsample_bytree": (0.5, 1.0, "float"),
                        "reg_lambda": (1e-2, 5, "float_log"), 
                        "reg_alpha": (1e-2, 5, "float_log"),  
                        "gamma": (0.0, 1.0, "float"), 
                        "scale_pos_weight": (1e-3, 50.0, "float_log"),
                        "verbosity": 0,
                        "priority": 130
                    ...
                    "LGB": {
                        "metric": (["None"], "cat"),
                        "learning_rate": (0.01, 0.1, "float_log"),  
                        "n_estimators": (50, 700, "int"),
                        "max_depth": (3, 15, "int"),
                        "num_leaves": (20, 255, "int"),
                        "feature_fraction": (0.5, 1.0, "float"),
                        "bagging_fraction": (0.5, 1.0, "float"),
                        "lambda_l1": (1e-2, 5, "float_log"), 
                        "lambda_l2": (1e-2, 5, "float_log"),  
                        "min_child_samples": (5, 100, "int"),
                        "boost_from_average": ([True, False], "cat"),
                        "verbosity": -1,
                        "priority": 120
                    ...
                    "CAT": {
                        ...
                        "max_depth": (4, 8, "int"),
                        "reg_lambda": (1e-2, 5, "float_log"), 
                        "random_strength": (1e-3, 5.0, "float_log"),  
                        "bagging_temperature": (0.0, 1.0, "float"),
                        "border_count": (32, 255, "int"),
                        "min_data_in_leaf": (1, 50, "int"), 
                        "verbose": False,
